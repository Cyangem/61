...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList expA = IntList.of(2,1,0);
        IntList actualA = IntList.reverse(A);
        assertEquals(expA, actualA);
        assertNotEquals(A, actualA);

        IntList B = IntList.of();
        IntList expB = IntList.of();
        IntList actualB = IntList.reverse(expB);
        assertEquals(B, expB);
        assertNotEquals(B, actualB);
    }
